...
<head>
    ...
    <link rel="stylesheet" href="shopowner.css">
    <title>Shopwoner Page</title>
    <style>
        body {
            padding-top: 80px;
            /* ความสูงของ navbar + สัก 20px เพื่อการเว้นวรรค */
            background-image: url("https://c0.wallpaperflare.com/preview/339/460/2/chef-chilli-chilli-peppers-cooker.jpg");
    ...
    <div class="navbar fixed-top">
        ...
        <div style="display: flex; flex-direction: column; align-items: flex-end; margin-right: 50px;">
            ...
            <ul class="dropdown-menu dropdown-menu-end">
                <li><a class="dropdown-item" href="shopwoner.php">หน้าหลัก</a></li>
        ...
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                <br>
                    ...
                    <a href='edit.php?PizzaID={$row["PizzaID"]}' class='btn btn-success'>Edit Pizza</a>
                    <br>
                </div>
            ";
                if ($counter % 3 == 2) {
