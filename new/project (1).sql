...
CREATE TABLE `combinedorder` (
  ...
  `PizzaID` int(11) DEFAULT NULL,
  `Quantity` int(11) DEFAULT NULL,
  `Status` enum('ยังไม่ส่ง','จัดส่งแล้ว') NOT NULL,
...
INSERT INTO `user` (`UserID`, `url`, `Username`, `PasswordHash`, `Role`, `name`, `phone`) VALUES
(1, 'https://media.tenor.com/AXhu_2lIQX4AAAAC/gojo-gojo-satoru.gif', 'satoru@gmail.com', '$2y$10$yJXhhW2Xh0BHOHEQKn5Zf.Ht08AJ2XD20MBstMw0NWAO7kHw9a652', 'ShopOwner', 'Gojo Satoru', 0),
(4, 'https://ovicio.com.br/wp-content/uploads/2023/07/20230712-ovicio-jujutsu-kaisen-data-crunchyroll-555x555.jpg', 'suguru@gmail.com', '$2y$10$Fs/7SRol4ZuHBTF9ODWkdermVJFhh.tAu80nwNl6VFShwlHUxu3PC', 'Customer', 'Geto Suguru', 0),
(5, '', 'Maki', '123', 'Customer', NULL, 0),
(6, '', 'Yuta', '123', 'Customer', NULL, 0),
(7, '', 'Panda', '123', 'Customer', NULL, 0),
(8, '', 'Magumi', '123', 'Customer', NULL, 0),
(9, '', 'Nobata', '123', 'Customer', NULL, 0),
(10, '', 'Meimei', '123', 'Customer', NULL, 0),
(11, '', 'Toge', '123', 'Customer', NULL, 0),
(12, '', 'Yuji', '123', 'Customer', NULL, 0);
...
--
-- Constraints for table `combinedorder`
--
ALTER TABLE `combinedorder`
  ADD CONSTRAINT `combinedorder_ibfk_1` FOREIGN KEY (`UserID`) REFERENCES `user` (`UserID`),
  ADD CONSTRAINT `combinedorder_ibfk_2` FOREIGN KEY (`PizzaID`) REFERENCES `pizza` (`PizzaID`),
  ADD CONSTRAINT `combinedorder_ibfk_3` FOREIGN KEY (`SizeID`) REFERENCES `size` (`SizeID`),
  ADD CONSTRAINT `combinedorder_ibfk_4` FOREIGN KEY (`CrustID`) REFERENCES `crust` (`CrustID`);
COMMIT;
